            ...
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                    <div className="bg-[#161B22] p-6 rounded-lg border border-gray-800">
                        <h3 className="text-xl font-bold mb-3 text-blue-400">User-Centric Design</h3>
                    ...
                    <div className="bg-[#161B22] p-6 rounded-lg border border-gray-800">
                        <h3 className="text-xl font-bold mb-3 text-green-400">Scalable Development</h3>
                        <p className="text-gray-400">
                            Great design deserves a robust foundation. I build with a component-driven architecture,
                            writing clean, reusable TypeScript code. This ensures consistency, simplifies maintenance,
                            and allows for rapid feature development and scaling, whether on web or mobile.
                        </p>
                    </div>
                </div>
            </div>
