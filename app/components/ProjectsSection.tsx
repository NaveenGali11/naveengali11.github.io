...
import Image from "next/image";
// import Link from "next/link"; // Temporarily commented out
import {projects} from "@/app/projects";
import {motion} from "framer-motion"; // Import motion
                ...
                <div className="space-y-20">
                    {projects.map((project, index) => (
                        <motion.div
                            ...
                            className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center"
                        >
                            {/* Visual Column (Image/Video) - Link is removed for now */}
                            <div
                                className={`relative w-full h-80 rounded-lg overflow-hidden shadow-2xl group transition-transform duration-300 hover:scale-105 ${
                                    index % 2 === 0 ? 'lg:order-2' : 'lg:order-1'
                                }`}
                            ...
                            <div className={`text-center lg:text-left ${
                                ...
                                {/* The "View Case Study" Link is also removed for now */}
                                <div
                                    className="group inline-flex items-center font-semibold text-blue-400 text-lg">
                                    View Case Study (Temporarily Disabled)
                                    <svg
