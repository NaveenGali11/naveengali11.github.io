                    ...
                    {[
                        {
                            ...
                            techDetails: [
                                ...
                                "Comprehensive Design System (Colors, Typography, Components)",
                                "Component-Based Architecture (15+ Reusable Components)",
                                "Advanced Interactive Prototyping",
                                "Auto Layout & Nested Components for Responsive Elements",
                                "Variants for Interactive States (Buttons, Filters)"
                            ],
                            ...
                            <div className="bg-[#21262D] rounded-lg overflow-hidden">
                                <div className="grid grid-cols-1 lg:grid-cols-2">
                                    ...
                                    <div className="relative h-full min-h-[300px] lg:min-h-full">
                                        ...
                                        />
                                        <div
                                            className="absolute inset-0 bg-gradient-to-b lg:bg-gradient-to-r from-[#21262D] via-transparent to-transparent lg:via-[#21262D]/20 lg:to-[#21262D]/40"></div>
                                    </div>
                                </div>
                            </div>
                        </a>
