  ...
  useEffect(() => {
    ...
    const init = () => {
      ...
      for (let i = 0; i < 200; i++) {
        ...
        particlesArray.push(
          new Particle(x, y, size, `hsl(${Math.random() * 360}, 50%, 50%)`)
        );
      }
    };
  ...
  return (
    <div className="relative min-h-screen bg-black">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center text-center px-4">
        ...
        >
          Passionate React and React Native developer specializing in modern
          frontend technologies and creating interactive UI/UX experiences.
        </motion.p>
